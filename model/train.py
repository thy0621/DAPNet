...
def train():
    ...
    adj_co = pd.read_csv('../data/adj_matrix.csv').values[:, 1:]  # 此处仅示例，论文中为 adj_matrix_co_net
    adj_gene = pd.read_csv('../data/adj_matrix.csv').values[:, 1:]  # 此处仅示例，论文中为 adj_matrix_gene_net
    adj_icd = pd.read_csv('../data/adj_matrix.csv').values[:, 1:]  # 此处仅示例，论文中为 adj_matrix_icd_net


    features_co = np.load('../data/Graph_embeddingfull.npy')  # 此处仅示例，论文中为 co_Graph_embeddingfull
    features_gene = np.load('../data/Graph_embeddingfull.npy') # 此处仅示例，论文中为 gene_Graph_embeddingfull
    features_icd = np.load('../data/Graph_embeddingfull.npy') # 此处仅示例，论文中为 icd_Graph_embeddingfull

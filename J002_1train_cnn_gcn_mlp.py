# 20220528 新增早停法，可以保存最优模型结果。如果连续300 epoch F1未超过最优结果，则终止
# 20220815 G010_01  刷新最好效果
# 20220815 G010_01 》》G010_2  刷新最好效果 gcn 输出32

# 20220921 H000_1 实现了loss曲线的绘制
# 20220921 H001  gcn层数实验
# 20220925 H002  输出维度实验
...
from J002_1model_cnn_gcn_mlp import GraphConvolution_cnn_gcn_mlp
